# Build experimental summary tables (expsum_*) and counts matrices (count_leaf, count_root)
...
save(expsum, expsum_leaf, expsum_root, file = "data/interim/expsum_built.rda")
if (exists("count_leaf")) save(count_leaf,  file = "data/interim/count_leaf_built.rda")
if (exists("count_root")) save(count_root, file = "data/interim/count_root_built.rda")
...
data.table::fwrite(expsum_root, "metadata/expsum_root.csv")
